...
plot_both(mycol = all3[2])
plot_both(mycol = all3[3])
plot_both(mycol = all3[4])
plot_both(mycol = all3[5])   #####
plot_both(mycol = all3[6])
plot_both(mycol = all3[7])
plot_both(mycol = all3[8])
plot_both(mycol = all3[9])
plot_both(mycol = all3[10])
plot_both(mycol = all3[11])
plot_both(mycol = all3[12])
plot_both(mycol = all3[13])
plot_both(mycol = all3[14])
plot_both(mycol = all3[15])
plot_both(mycol = all3[16])
plot_both(mycol = all3[17])
plot_both(mycol = all3[18])
plot_both(mycol = all3[19])
plot_both(mycol = all3[20])
plot_both(mycol = all3[21])
plot_both(mycol = all3[22])
plot_both(mycol = all3[23])
plot_both(mycol = all3[24])
plot_both(mycol = all3[25])
plot_both(mycol = all3[26])
plot_both(mycol = all3[27])
plot_both(mycol = all3[28])
plot_both(mycol = all3[29]) 
```
