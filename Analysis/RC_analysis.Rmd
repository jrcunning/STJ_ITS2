...
fig1 <- plot_grid(fig1a, fig1b, nrow = 2, rel_heights = c(0.4, 0.6), labels = c("a)", ""), label_y = 0.9) + 
...
# Save heatmap as Figure S1
ggsave(figS1, filename = "output/FigureS1.png", device = "png", width = 60, height = 60, units = "mm")
...
# Save heatmap as Figure S1
ggsave(figS2, filename = "output/FigureS2.png", device = "png", width = 60, height = 60, units = "mm")
